...
place_1 = Place.create(name: 'Estadio Nacionalsdfhgdsfhdfshfdsh', address:'Av. Grecia 2001', capacity: 50000)
place_2 = Place.create(name: 'Teatro Caupolicansfhshdshshd', address:'San Diego 850', capacity: 5000)
